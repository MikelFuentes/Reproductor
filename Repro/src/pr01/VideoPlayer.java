...
public class VideoPlayer extends JFrame {
	...
	private static File pedirCarpeta() {
		JFileChooser choser = new JFileChooser("D:\\Documentos\\Workspace\\Repro\\src\\pr01");
		choser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		int valPath = choser.showOpenDialog(null);      
        if (valPath == 0) {
	...
	public static void main(String[] args) {
		...
		args = new String[] { "*Pentatonix*.mp4", "pr01/res/" };
		if (args.length < 2) {
